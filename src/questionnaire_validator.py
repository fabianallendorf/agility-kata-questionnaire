...
class QuestionnaireValidator:
    ...
    def validate_answers(
        questions: list[Question], user_answers: list[Answer]
    ) -> list[ValidatedQuestion]:
        validated_questions = []
        for question in questions:
            validated_question = QuestionnaireValidator.validate_answer(
    ...
    def validate_answer(question: Question, user_answers: list[Answer]):
        ...
        validated_answer = QuestionnaireValidator.check_is_answered_correctly(
            answered_question
        )
